...
**Scope:**
Search through my emails, chats, and recent documents (from the past week) to identify incoming requests, compliance mandates, and strategic initiatives. Do not rely solely on project management tools; use communication signals for real-time priority shifts.
...
2.  **Scan for Commercial Opportunities:** Search for "growth," "campaign," "ROI," "segmentation," or "strategy" to identify "Strategic" items.
...
5.  **Categorize:** Group items into "Regulatory & Compliance" (Must Do), "Commercial & Growth" (Strategic), and "Operational & Maintenance" (Keep the Lights On).

**Deep Thinking:**
Use Deep Thinking mode to ensure no critical Regulatory deadline is missed and that Commercial priorities align with broader business goals.
...
2.  **Summary Table:**
    *   A concise table: | Priority | Task Name | Category (Reg/Growth/Ops) | Owner | Stakeholder | Deadline |
