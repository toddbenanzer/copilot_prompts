...
5.  **Categorize:** Group items into Regulatory (Must Do), Commercial (Strategic), and Operational (Keep the Lights On).
...
2.  **Summary Table:**
    *   A concise table: | Priority | Task Name | Category (Reg/Growth) | Owner | Stakeholder | Deadline |
